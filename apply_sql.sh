#!/bin/bash
MYSQL="/c/Program Files/MySQL/MySQL Server 9.7/bin/mysql" -u root -p123456
$MYSQL -e "
USE auragate;
...
INSERT INTO user (user_id, user_name, password, nickname, status) VALUES (1, 'admin', '123456', '管理员', 0);
CREATE TABLE role (
...
INSERT INTO role (id, role_name, role_key, status) VALUES (1, '管理员', 'admin', 0);
CREATE TABLE menu (
